      ...
      >
        ...
        {src && (
          <image
            ...
            height="350"
            preserveAspectRatio="xMidYMid slice"
            clipPath="url(#roundedCornersiPad)"
          />
        )}
        <rect x="135" y="382" width="30" height="3" rx="1.5" fill="#333" />
        <defs>
          <clipPath id="roundedCornersiPad">
            <rect x="20" y="25" width="260" height="350" rx="4" />
          </clipPath>
        </defs>
      </svg>
    )
